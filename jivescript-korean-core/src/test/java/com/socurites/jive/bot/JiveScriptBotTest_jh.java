...
public class JiveScriptBotTest_jh extends AbstractJiveTestCase {
	...
	public void filePriority() {
		String templateDirResourcePath = "script/file_priority";
		String message = "봇 안녕!";
		
		JiveScriptBot bot = getBot(templateDirResourcePath, enableAnalyze);
